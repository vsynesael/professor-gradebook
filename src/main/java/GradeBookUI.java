...
public class GradeBookUI extends javax.swing.JFrame implements ActionListener,
	 ...
	 */
	private static void createTab(String title, final JPanel panel) {
		...
		btnClose.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				btnCloseActionPerformed(evt, panel);
			}
		});
	 ...
	 *            event handler
	 */
	private static void btnCloseActionPerformed(java.awt.event.ActionEvent evt, JComponent component) {
